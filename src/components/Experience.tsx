...
const experiences = [{
  ...
  description: 'Developed backend services for inventory management system and garage management system using Django DRF and PostgreSQL.',
  achievements: ['Developed RESTful APIs', 'Implemented database solutions', 'Optimized performance']
}, {
  period: '2025 - present',
  company: "Po'o Tecnologies Software Development Agency",
  role: 'Flutter Developer',
  description: 'Built  inventory management mobile applications with Flutter and Django backend.',
  // achievements: ['Developed cross-platform mobile app', 'Implemented CI/CD pipeline']
  achievements: ['Developed cross-platform mobile app', 'Optimized performance', 'Responsive UI']
}];
        ...
        <div className="space-y-12">
          ...
          delay: index * 0.1
              ...
              <ul className="space-y-2">
                {exp.achievements.map(achievement => <li key={achievement} className="flex items-start gap-2 text-gray-400">
