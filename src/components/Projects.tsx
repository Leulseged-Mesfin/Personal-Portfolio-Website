...
const projects = [
  {
    ...
    description:
      " Designed and deployed a Django-based inventory management system that automated stock tracking and reduced human error, improving inventory accuracy by 95%, cutting operational costs and reducing order processing times by 50%.",
  ...
  },
  {
    ...
    description:
      "Designed and developed a custom Garage Management System backend using Django RESTFramework, enabling the client to automate vehicle intake, service tracking, mechanics’ assignments, and billing, increasing operational efficiency.",
    tech: ["Python", "Django DRF", "MySQL", "CPanel", "Git"],
    github: "https://github.com",
    highlight: "Backend",
  },
...
export function Projects() {
  return (
    <section className="px-6 md:px-12 lg:px-24 py-32 bg-[#151515]">
            ...
            >
                ...
                <div className="flex gap-3">
                  {project.github && (
                    <a
                      ...
                      className="p-2 border border-gray-700 rounded-lg hover:border-gray-600 hover:bg-gray-900 transition-colors"
                    >
              ...
              <div className="flex flex-wrap gap-2">
                {project.tech.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 bg-gray-900 text-gray-400 text-sm rounded-md font-mono"
                  >
                    {tech}
                  </span>
                ))}
