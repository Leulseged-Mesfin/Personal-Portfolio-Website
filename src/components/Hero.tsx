...
export function Hero() {
  return <section className="min-h-screen flex items-center px-6 md:px-12 lg:px-24 py-6">
        ...
        ease: 'easeOut'
          ...
          <div>
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              ...
              Specializing in API design, and Flutter
              development.
            </p>
          ...
          <div className="flex flex-col justify-end">
            <div className="flex gap-4">
              <motion.a href="mailto:alex@example.com" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
              ...
              <motion.a href="https://github.com" target="_blank" rel="noopener noreferrer" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
